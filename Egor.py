...
def qd(q1, q2, p1, p2):
    '''
    Aim of using: reconstruction of a linear function of demand based on two states of the market.
    q1 - amount of products consumed for a price equal to p1
    q2 - amount of products consumed for a price equal to p2
    return: functional dependence of the quantity of demand for products from the price on the market.
    '''
    b = (q2 - q1) / (p2 - p1)
    a = q1 - b * p1
    pd = sy.Symbol("pd")
...
def p(q1, q2, p1, p2, q):
    '''
     aim of using: reconstruction of a function inverse for a linear demand based on two states of the market.
     q1 - amount of products consumed for a price equal to p1
     q2 - amount of products consumed for a price equal to p2
     return: functional dependence of a price on the market from the quantity of demand for products.
    '''
    b = (q2 - q1) / (p2 - p1)
    a = q1 - b * p1
    return (q - a) / b
...
def tr(qx):
    '''
    Aim of using: estimating the value of total revenue got by a monopoly after realisation quantity of products
    equal to qx in case of the linear form of demand.
